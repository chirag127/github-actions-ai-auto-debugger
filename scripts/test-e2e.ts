...
const WEBHOOK_SECRET = "We will update this after deploying our Cloudflare Worker";
const WORKER_URL = "https://github-actions-ai-auto-debugger.whyiswhen.workers.dev";
...
async function runTest() {
    ...
    try {
        ...
        if (res.status === 500 && text.includes("Failed to get installation token")) {
            console.log("✅ TEST SUCCESSFUL!");
            console.log("The Worker successfully validated the Webhook Signature and tried to authenticate to GitHub.");
            console.log("It threw a 500 only because the mock installation ID (1234567) does not exist.");
        } else {
